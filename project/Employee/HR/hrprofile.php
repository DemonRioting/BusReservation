...
if(isset($_POST['submit']))
  {
    ...
    $Email=$_POST['Email'];
     ...
     $query=mysqli_query($con, "update EmployeeInfo set Username ='$Username', Firstname ='$Firstname',Lastname ='$Lastname' ,Email ='$Email' where EmployeeID='$hrid'");
    if ($query) {
    $msg="HR profile has been updated.";
  }
  else
    {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">HR Profile</h1>
...
<form class="user" method="post" action="">
  <?php
$hrid=$_SESSION['hid'];
$ret=mysqli_query($con,"select * from EmployeeInfo where EmployeeID='$hrid'");
$cnt=1;
