...
$query=mysqli_query($con,"select EmployeeID from EmployeeInfo where EmployeeID='$staffid' and 	Passwords='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update EmployeeInfo set Passwords='$newpassword' where EmployeeID='$staffid'");
...
<form name="changepassword" class="user" method="post" onsubmit="return checkpass();">
  <?php
$staffid=$_SESSION['sid'];
$ret=mysqli_query($con,"select * from EmployeeInfo where EmployeeID='$staffid'");
$cnt=1;
