...
if(isset($_POST['submit']))
  {
    ...
    $Email=$_POST['Email'];
     ...
     $query=mysqli_query($con, "update EmployeeInfo set Username ='$Username', Firstname ='$Firstname',Lastname ='$Lastname' ,Email ='$Email' where EmployeeID='$staffid'");
    if ($query) {
    $msg="Staff profile has been updated.";
  }
  else
    {
