...
if(isset($_POST['submit']))
  {
    ...
    $Email=$_POST['Email'];
     ...
     $query=mysqli_query($con, "update EmployeeInfo set Username ='$Username', Firstname ='$Firstname',Lastname ='$Lastname' ,Email ='$Email' where EmployeeID='$managerid'");
    if ($query) {
    $msg="Bus Schedule Manager profile has been updated.";
  }
  else
    {
...
<head>
  ...
  <title>Bus Schedule Manager Profile</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Bus Schedule Manager Profile</h1>
...
<form class="user" method="post" action="">
  <?php
$managerid=$_SESSION['mid'];
$ret=mysqli_query($con,"select * from EmployeeInfo where EmployeeID='$managerid'");
$cnt=1;
