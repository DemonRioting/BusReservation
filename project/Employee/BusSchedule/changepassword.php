...
$query=mysqli_query($con,"select EmployeeID from EmployeeInfo where EmployeeID='$managerid' and 	Passwords='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update EmployeeInfo set Passwords='$newpassword' where EmployeeID='$managerid'");
