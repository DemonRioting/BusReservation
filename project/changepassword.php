...
$query=mysqli_query($con,"select CustomerID from CustomerInfo where CustomerID='$CustomerID' and 	Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update CustomerInfo set Password='$newpassword' where CustomerID='$CustomerID'");
...
<form name="changepassword" class="user" method="post" onsubmit="return checkpass();">
  <?php
$cid=$_SESSION['uid'];
$ret=mysqli_query($con,"select * from CustomerInfo where CustomerID='$cid'");
$cnt=1;
...
?>
               <div class="row">
                <div class="col-4 mb-3">Current Password</div>
                   <div class="col-8 mb-3">   <input type="Password" class="form-control form-control-user" id="Password" name="currentassword"  value="" required="true"></div>
                    </div>  
                    <div class="row">
