...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select CustomerID from CustomerInfo where  Username='$Username' && Password='$Password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['uid']=$ret['CustomerID'];
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    <div class="form-group">
                      <input type="Username" class="form-control form-control-user" id="Username" name="Username" aria-describedby="Username" placeholder="Username" required="true">
                    </div>
                    <div class="form-group">
