...
<body>
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<form class="contact100-form validate-form" action="passengerinfo2_submit.php" method="POST">
				<span class="contact100-form-title">
					Passenger Info
				</span>

                <div class="wrap-input100">
                    <span class="label-input100">Passenger 1</span>
				</div>
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Email">
                 ...
                 <div class="wrap-input100">
                    <span class="label-input100">Passenger 2</span>
				</div>

                <div class="wrap-input100 input100-select bg1 rs1-wrap-input100">
					<span class="label-input100">Title *</span>
					<div>
						<select class="js-select2" name="passengerTitle2">
							<option value = NULL>none</option>
							<option value = "Mr.">Mr.</option>
							<option value = "Mrs.">Mrs.</option>
							<option value = "Ms.">Ms.</option>
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type First Name">
					<span class="label-input100">First Name *</span>
					<input class="input100" type="text" name="firstName2" placeholder="Enter Your First Name">
				</div>

                <div class="wrap-input100 input100-select bg1 rs1-wrap-input100">
					<span class="label-input100">Gender *</span>
					<div>
						<select class="js-select2" name="passengerGender2">
							<option value = "M">Male</option>
							<option value = "F">Female</option>
							<option value = "O">Other</option>
						</select>
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Last Name">
					<span class="label-input100">Last Name *</span>
					<input class="input100" type="text" name="lastName2" placeholder="Enter Your Last Name">
				</div>

                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Date of Birth">
					<span class="label-input100">Date of Birth *</span>
					<input class="input100" type="date" name="birthDate2" placeholder="Enter Your Date of Birth ">
				</div>

                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Nationality">
					<span class="label-input100">Nationality *</span>
					<input class="input100" type="text" name="nationality2" placeholder="Enter Your Nationality">
				</div>

                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Religion">
					<span class="label-input100">Religion *</span>
					<input class="input100" type="text" name="religion2" placeholder="Enter Your Religion">
				</div>

				<div class="wrap-input100 rs1-wrap-input100">
				    <span class="label-input100">ID Card</span>
				    <input class="input100" type="text" name="IDCard2" placeholder="Enter Your ID Card">
				 </div>
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Please Type Email">
				    <span class="label-input100">Email *</span>
				    <input class="input100" type="text" name="email2" placeholder="Enter Your Email">
				 </div>

                 <div class="wrap-input100 rs1-wrap-input100">
				    <span class="label-input100">Phone Number *</span>
				    <input class="input100" type="text" name="phoneNumber2" placeholder="Enter Your Phone Number">
				 </div>
